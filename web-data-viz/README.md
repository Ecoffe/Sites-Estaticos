...
- Exemplo, se você quiser a funcionalidade de adicionar um novo Aquário, deve criar arquivos referentes ao estufa nos diretórios e replicar também as funções.  
